...
import utils
from hyperparameters import ALPHA, EPSILON, TRACKING_METHOD, LOAD_INSTEAD_OF_RECALCULATION
...
if __name__ == '__main__':
    ...
    for line_index in range(start_line, end_line):
        ...
        v[counter] = utils.calc_ppr_by_power_iteration(P_new, ALPHA, h_new, 20)
