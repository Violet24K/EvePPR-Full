...
if __name__ == '__main__':
    ...
    for line in all_line:
        ...
        node1 = int(items[0])
        node2 = int(items[1])
        change_to = int(items[2])
        edge_attr_matrix_2[node1, node2] = change_to
        edge_attr_matrix_2[node2, node1] = change_to
        ...
        node_in_sub1 = match_from_whole_to_sub(node1)
        node_in_sub2 = match_from_whole_to_sub(node2)
        edge_attr_matrix_1[node_in_sub1, node_in_sub2] = change_to
        edge_attr_matrix_1[node_in_sub2, node_in_sub1] = change_to
        counter += 1
        print('change time: ', time_stamp)
        print('sub change time: ', counter)
